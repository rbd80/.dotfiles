...
# ~/AppConfigs.sh — Originally from https://mths.be/osx

# Ask for the administrator password upfront
sudo -v

# Keep-alive: update existing `sudo` time stamp until `AppConfigs.sh` has finished
...
tell application "Terminal"
    ...
    do shell script "open '$HOME/osx-terminal.app-colors-solarized/" & themeName & ".terminal'"
